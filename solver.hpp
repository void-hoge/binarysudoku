...
public:
	...
	bool dfs(Board<size> bd, uint32_t pos, uint8_t num, bool fullsearch, bool savesolution);
	void solve(Board<size> bd, bool fullsearch=false, bool savesolution=true);
